...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VNetGateways) DeepCopyInto(out *VNetGateways) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VNetGateways.
func (in *VNetGateways) DeepCopy() *VNetGateways {
	if in == nil {
		return nil
	}
	out := new(VNetGateways)
	in.DeepCopyInto(out)
	return out
}
